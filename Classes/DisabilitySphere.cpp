...
{
	return ToolFunction::WStr2UTF8(L"²Ð·Ï·¨Çò:\n")
		+ ToolFunction::WStr2UTF8(L"Á¦Á¿:") + strOffset + "\n"
		+ ToolFunction::WStr2UTF8(L"Ãô½Ý:") + agiOffset + "\n"
		+ ToolFunction::WStr2UTF8(L"ÖÇÁ¦:") + intOffset + "\n";
}
