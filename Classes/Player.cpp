...
void Player::init()
{
	...
	characterPtr->addSkill(L"fireBall_øÏÀŸª«Ú_20_20_20_5");
	characterPtr->addSkill(L"HPRecoverySelf_…˙√¸ª÷∏¥_20_20_20");
	characterPtr->addSkill(L"MPRecoverySelf_ƒß∑®ª÷∏¥_20_20_100");
	characterPtr->addSkill(L"HPRecoveryCast_÷Œ¡∆_20_20_100");
	characterPtr->addSkill(L"MPRecoveryCast_ƒß∑®‘ˆ¡ø_20_20_100");
	...
	//////////////////////////////////////////////////////////////////////////
	std::wstring buffname0 = L"WeightBuff_∏∫÷ÿÃ·∏ﬂ_ATTR_Good_4_20_100";
	characterPtr->addBuff(ToolFunction::WStr2UTF8(buffname0));

	std::wstring buffname1 = L"ChantBuff_◊‘∂Ø“˜≥™_OnRoundStart_Good_10_20_1";
	characterPtr->addBuff(ToolFunction::WStr2UTF8(buffname1));

	std::wstring buffname2 = L"BlockProBuff_∏Òµ≤‘ˆº”_ATTR_Good_4_100_100";
	...
	//	std::wstring buffname2 = L"VertigoBuff_—£‘Œ_ATTR_Bad_2_10";
	//	characterPtr->addBuff(ToolFunction::WStr2UTF8(buffname2));

	characterPtr->speak(L"Õ¬≤€≤‚ ‘Õ¬≤€≤‚ ‘Õ¬≤€≤‚ ‘Õ¬≤€≤‚ ‘Õ¬≤€≤‚ ‘Õ¬≤€≤‚ ‘Õ¬≤€≤‚ ‘Õ¬≤€≤‚ ‘Õ¬≤€≤‚ ‘");
}
